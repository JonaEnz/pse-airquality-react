...
export class Feature {
    ...
    constructor(id: string, nameId: string, descriptionId: string, scale: Scale, relatedWeblinkId: string, limit: number, unitOfMeasurement: string, drawableDiagramIds: string[]) {
        this.id = id;
        this.nameId = nameId;
