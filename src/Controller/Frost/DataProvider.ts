...
export default class DataProvider {
    ...
    private server: FrostServer;

    constructor() {
        this.server = new FrostServer("https://api.smartaq.net/v1.0/");
    }
    ...
    async getObservationStations(middle: Position, radius: number): Promise<ObservationStation[]> {
    ...
    async getLatestObservation(station: ObservationStation, feature: Feature): Promise<Observation> {
    ...
    async getStation(id: string): Promise<ObservationStation> {
